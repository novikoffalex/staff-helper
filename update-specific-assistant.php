...
$assistantId = 'asst_kPICBVUA3WIm5qO1r4r78jMd';
...
echo "🔗 Прямая ссылка:\n";
echo "   https://platform.openai.com/playground/assistants?assistant={$result['id']}\n\n";

echo "🎉 Готово! Теперь обновите ID в Heroku:\n";
echo "   heroku config:set OPENAI_ASSISTANT_ID={$assistantId} --app staff-helper\n";
?>
